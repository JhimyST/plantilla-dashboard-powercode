$(document).ready(function () {
  let table_gestion_salones = $("#table-gestion-salones");
  ...
  inputExcel.addEventListener("change", async function (e) {
    ...
    $("#confirmImport").click(function (e) {
      ...
      let tableGestionSalones = table_gestion_salones.DataTable({
        lengthMenu: [
          [10, 25, 50, -1],
          [10, 20, 50, "All"],
        ],
        ...
        columns: [
          ...
          { title: "Semestre", className: "uniqueClassName" },
          ...
          <div class="row g-2 mx-2">
            ...
            <div class="col col-lg-12 col-xl-6  px-0">
              <a id="matricAlumnos" class="btn btn-success" href="#" role="button"><i class="bi bi-clipboard2-plus"></i> Matricular</a>
            </div>
				  </div>
